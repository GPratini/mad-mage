  ...
  return (
    <div>
      ...
      <div id="info">
        ...
        {salaAtiva==="1-1" && <p className='sala' id='1-1'>
        ...
        {salaAtiva==="1-2a" && <p className='sala' id='1-2a'>
        ...
        {salaAtiva === "1-2b" && <p className='sala' id='1-2b'>
        ...
        {salaAtiva === "1-3" && <p className='sala' id='1-3'>
          ...
          <strong>Ooze.</strong> A psychic gray ooze lurks beneath the murky water, north of the statue. (It's invisible while underwater.)<br></br>
