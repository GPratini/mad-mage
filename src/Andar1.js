export const Mapa1 = {
  ...
  areas: [
    ...
    },
    {
      ...
      shape: "rect",
      coords: [534, 1018, 663, 1095]
    },
    {
      id: "1-5",
      name: "Grell Hideout",
      shape: "poly",
      coords: [89, 939, 89, 811, 112, 809, 115, 834, 194, 836, 191, 864, 219, 865, 222, 888, 191, 888, 194, 941]
    },
    {
      id: "1-6a",
    ...
    },
    {
      ...
      shape: "rect",
      coords: [244, 550, 270, 575]
    },
    {
      id: "1-11",
      name: "Room of Secrets",
      shape: "rect",
      coords: [327, 623, 376, 577]
    },
    {
      id: "1-12",
      name: "Hall of Heroes",
      shape: "rect",
      coords: [350, 342, 910, 288]
    },
    {
      id: "1-13",
      name: "Empty Room",
      shape: "rect",
      coords: [531, 444, 557, 472]
    },
    {
      id: "1-14a",
    ...
    },
    {
      ...
      name: "Armory",
      shape: "poly",
      coords: [816, 498, 816, 470, 792, 470, 793, 368, 869, 368, 870, 470, 844, 469, 844, 497]
    },
    {
      id: "1-16",
      name: "Manticore Den",
    ...
    {
      id: "1-27",
      name: "Hidden Demiplane",
      shape: "rect",
      coords: [739, 1590, 767, 1566]
    },
    {
      id: "1-28a",
    ...
    },
    {
      ...
      name: "Delvers' Hall",
      shape: "poly",
      coords: [1468, 1331, 1468, 1303, 1545, 1305, 1546, 1330, 1522, 1328, 1522, 1357, 1546, 1357, 1546, 1385, 1522, 1382, 1522, 1408, 1494, 1407, 1494, 1384, 1469, 1384, 1469, 1408, 1441, 1408, 1443, 1384, 1417, 1384, 1417, 1408, 1391, 1407, 1391, 1384, 1341, 1382, 1343, 1357, 1492, 1357, 1492, 1331]
    },
    {
      id: "1-32a",
    ...
    },
    {
      ...
      shape: "poly",
      coords: [1624, 1254, 1602, 1234, 1602, 1198, 1624, 1174, 1702, 1174, 1702, 1254]
    },
    {
      id: "1-34",
      name: "South Dormitory",
      shape: "poly",
      coords: [1602, 1338, 1602, 1302, 1625, 1279, 1701, 1278, 1702, 1355, 1625, 1361]
    },
    {
      id: "1-35",
      name: "Hall of Rats",
      shape: "poly",
      coords: [1261, 1304, 1262, 1329, 1207, 1329, 1207, 1252, 1391, 1255, 1392, 1329, 1337, 1331, 1338, 1304, 1312, 1304, 1312, 1354, 1286, 1354, 1286, 1306]
    },
    {
      id: "1-36a",
...
export function Salas1({ salaAtual }) {
  return (
    <div>
      {salaAtual === "1-enc" && <div className='sala' id='1-enc'>
        <p>Monsters wander this level in search of food or treasure. These creatures include carrion crawlers, ghouls, giant spiders, goblins, grells, gricks, oozes of all kinds, stirges, and wererats. If your game session needs a jolt, try using one of the following encounters or an encounter of your own design.</p>

        <p><strong>Carrion Crawlers</strong> Three carrion crawlers, one creeping along the floor and two attached to the ceiling, approach the party and attack the first adventurers to come within reach of their mucus-coated tentacles. If a carrion crawler paralyzes a character with its tentacles, it continues to make bite attacks against that character on subsequent rounds as it feeds. The carrion crawlers are too stupid and hungry to flee in the face of certain death.</p>

        <p><strong>Goblin Skull-Hunters</strong> Pibble and Groin, two argumentative goblins with no affiliations of note, are scouring the dungeon for intact skulls to claim as trophies. Their constant bickering can be heard up to 60 feet away, and they flee when confronted by adventurers. If one or both goblins are captured, they can lead adventurers to the nearest Xanathar Guild watch post as well as describe its defenses, since they have observed the comings and goings of the guild's goblinoids for some time.</p>

        <p><strong>Lost Adventurer.</strong> A clearly injured adventurer is trying to find his way back to the Yawning Portal. His group got separated and he didn’t know the way back. He doesn’t have much to offer in exchange for help, other than telling them about what he has seen in the level.</p>

        <p><strong>Arcamag</strong> A ring on the floor glows in the torchlight, it seems magical. In reality it is an <a href="https://5e.tools/bestiary.html#arcamag_ccodex">arcamag</a> looking for a host.</p>
      </div>}
      ...
      {salaAtual === "1-2b" && <div className='sala' id='1-2b'>
        ...
        <p><strong>Bugbears.</strong> Two <a href="https://5e.tools/bestiary.html#bugbear_xmm" target="blank">bugbears</a> hide behind pillars. (Each bugbear is host to an <a href="https://5e.tools/bestiary.html#intellect%20devourer_xmm" target="blank">intellect devourer</a> in its skull cavity.)<br></br>
      ...
      {salaAtual === "1-3" && <div className='sala' id='1-3'>
        ...
        <p><strong>Flood.</strong> The floor of the room tilts—its west end is 6 feet lower than its east end. Foul sewer water covers the floor, barely reaching the east wall but deepening by 1 foot for every 10 feet of travel westward.<br></br>
          ...
          <strong>Ooze.</strong> A <a href="https://5e.tools/bestiary.html#gray%20ooze_xmm" target="_blank" rel="noreferrer">psychic gray ooze</a> lurks beneath the murky water, north of the statue. (It's invisible while underwater.) The ooze uses its Psychic Crush action option (see the "Variant: Psychic Gray Ooze" sidebar in the "Oozes" entry in the Monster Manual) to attack anyone who approaches the statue.</p>
      ...
      {salaAtual === "1-5" && <div className='sala' id='1-5'>
        <p>At the end of a long hall is a 50-foot-square room with five pillars made of mortared humanoid bones, painted black. Two <a href="https://5e.tools/bestiary.html#grell_xmm" target="blank">grells</a> float in separate alcoves to the north and the east. The floors of the alcoves are littered with the gnawed bones of past meals (mostly goblins and gricks).</p>
      ...
      {salaAtual === "1-6a" && <div className='sala' id='1-6a'>
        <p>Several members of the Undertakers gang dwell here in their vampire disguises. If the bandit keeping an eye on area 1 through the secret door retreats here with news of the adventurers' arrival, add that individual to the forces arrayed here (one <a href="https://5e.tools/bestiary.html#bandit%20captain_xmm" target="blank">bandit captain</a>, six <a href="https://5e.tools/bestiary.html#bandit_xmm" target="blank">bandits</a>, and two <a href="https://5e.tools/bestiary.html#doppelganger_xmm" target="blank">doppelgangers</a>). Once alerted, these forces gather in area 6a and wait for the adventurers to arrive so they can extort money from them.</p>
      ...
      {salaAtual === "1-6c" && <div className='sala' id='1-6c'>
        ...
        <p><strong>Bandits.</strong> Unless they have been encountered elsewhere, four members of the Undertakers sit around a decrepit wooden table near the door: Uktarl Krannoc (NE human <a href="https://5e.tools/bestiary.html#bandit%20captain_xmm" target="blank">bandit captain</a> with Performance +4), two human <a href="https://5e.tools/bestiary.html#bandit_xmm" target="blank">bandits</a>, and a <a href="https://5e.tools/bestiary.html#doppelganger_xmm" target="blank">doppelganger</a>, all disguised as vampires. They play cards using a marked deck that Uktarl carries around, and each has a stack of coins on the table.<br></br>
      ...
      {salaAtual === "1-8b" && <div className='sala' id='1-8b'>
        ...
        <p><strong>Bandit Captain.</strong> Unless awakened by loud noises, Harria Valashtar (NE human <a href="https://5e.tools/bestiary.html#bandit%20captain_xmm" target="blank">bandit captain</a> with Performance +4) sleeps on a cot against the south wall. She is disguised as a vampire but doesn't wear her fangs while sleeping.<br></br>

          <strong>Golem.</strong> A <a href="https://5e.tools/bestiary.html#flesh%20golem_xmm" target="blank">flesh golem</a> under Harria's control stands guard in the middle of the room.<br></br>
      ...
      {salaAtual === "1-8c" && <div className='sala' id='1-8c'>
        ...
        <p><strong>Bandits.</strong> Sitting in chairs around a long stone table are five human <a href="https://5e.tools/bestiary.html#bandit_xmm" target="blank">bandits</a> (members of the Undertakers, all disguised as vampires) and a <a href="https://5e.tools/bestiary.html#doppelganger_xmm" target="blank">doppelganger</a> (disguised to look like a sixth human vampire).<br></br>
      ...
      {salaAtual === "1-13" && <div className='sala' id='1-13'>
        <p>The door to this room is carved on the outside reading "Don't open. Magic brooms", and is barred from the outside.</p>

        <p>Inside are 14 <a href="https://5e.tools/bestiary.html#animated%20broom_cm" target="blank">animated brooms</a> that try to "sweep" the walls and characters, atacking them.</p>
      </div>}
      ...
      {salaAtual === "1-14b" && <div className='sala' id='1-14b'>
        <p><strong>Acid.</strong> The room's domed ceiling is 15 feet high at the edges and 30 feet high in the middle. The dome is filled with sizzling acid that defies gravity as it floats 15 feet above the floor.<br></br>

          <strong>Statue.</strong> An 8-foot-tall statue of a four-armed fish monster (a petrified <a href="https://5e.tools/bestiary.html#sahuagin%20baron_xmm" target="blank">sahuagin baron</a> with no trident) stands in the middle of the room, facing north. Its webbed hands clutch an ornate, 1-foot-square stone box with a lid and a keyhole (see "Box" below).<br></br>
        ...
        <p><strong>Box.</strong> The box can be unlocked and opened while the statue holds it. Prying it from the statue's grasp requires a successful DC 20 Strength (Athletics) check and causes the petrified <a href="https://5e.tools/bestiary.html#sahuagin%20baron_xmm" target="blank">sahuagin baron</a> to revert to flesh, attacking with its teeth and claws.</p>
      ...
      {salaAtual === "1-14c" && <div className='sala' id='1-14c'>
        <p>This room has an empty pedestal in the middle of it. On the floor in front of the pedestal is a single boot, some pieces of armor, torn fabric and dried blood. Nearby is an opened flask with a little liquid inside.</p>

        <p>The flask is <a href="https://5e.tools/items.html#sovereign%20glue_dmg" target="blank">sovereign glue</a> with two ounces remaining. A previous adventurer found it but accidentally spilled some and glued the other items on the floor, along with some skin that has since been decomposed away.</p>
      </div>}
      {salaAtual === "1-15" && <div className='sala' id='1-15'>
        <p><strong>Racks.</strong> Cobwebs enshroud rows of old weapon racks, many of which have collapsed under their own weight.<br></br>
      ...
      {salaAtual === "1-16" && <div className='sala' id='1-16'>
        <p><strong>Manticores.</strong> Three <a href="https://5e.tools/bestiary.html#manticore_xmm" target="blank">manticores</a> dwell here.<br></br>
      ...
      {salaAtual === "1-17b" && <div className='sala' id='1-17b'>
        <p><strong>Ceiling.</strong> The ceiling is 60 feet high.<br></br>

          <strong>Petrified Creatures.</strong> Eleven lifelike statues in a variety of poses are clustered together in the south end of the room. (These statues are petrified creatures.)<br></br>

          <strong>Statues.</strong> Alcoves along the walls once held six statues, but five of them lie toppled and smashed to pieces on the floor. The sixth statue, located in the middle alcove along the east wall, remains intact and appears to be made of glistening black stone. (The sheen is due to a <a href="https://5e.tools/bestiary.html#black%20pudding_xmm" target="blank">black pudding</a> that coats the statue.)</p>
      ...
      {salaAtual === "1-18" && <div className='sala' id='1-18'>
        ...
        <p>A voracious <a href="https://5e.tools/bestiary.html#troll_xmm" target="blank">troll</a> hunkers in the room's southwest corner and attacks interlopers on sight. It can't be surprised by adventurers who are noisy or who approach with uncovered light sources.</p>
      ...
      {salaAtual === "1-19a" && <div className='sala' id='1-19a'>
        <p><strong>Furnishings.</strong> Two 20-foot-long, 5-foot-wide stone tables stand in the middle of each room, flanked by stone benches.<br></br>
      ...
      {salaAtual === "1-19b" && <div className='sala' id='1-19b'>
        ...
        <p>On the table are three simple iron helmets, two iron masks and one bronze mask molded to resemble Halaster's visage (50 gp).</p>
      </div>}
      ...
      {salaAtual === "1-21" && <div className='sala' id='1-21'>
        <p><strong>Mirrors.</strong> Eight pairs of niches, each 3 feet deep, line the north and south walls. Mounted on the back wall inside each one is a large, oval glass mirror in a heavy stone frame—sixteen mirrors in all.<br></br>
        ...
        <ul>
          ...
          <li>16 A swarm of scorpions, which immediately attacks. It has the statistics of a <a href="https://5e.tools/bestiary.html#swarm%20of%20insects_xmm" target="blank">swarm of insects</a> but it's only action is:<br></br>
      ...
      {salaAtual === "1-23a" && <div className='sala' id='1-'>
        <p>The Xanathar Guild maintains a watch post here, called "Worg's Eye" by the bugbears that command it. The goblinoids stationed here, two <a href="https://5e.tools/bestiary.html#bugbear_xmm" target="blank">bugbears</a> and fifteen <a href="https://5e.tools/bestiary.html#goblin_xmm" target="blank">goblins</a>, can't be surprised if they know trouble is on the way. If the two bugbears in area 2b managed to make it this far, add them to the roster of enemies.</p>
      ...
      {salaAtual === "1-23b" && <div className='sala' id='1-23b'>
        ...
        <p><strong>Bugbears.</strong> Two bugbears stand guard. Each bugbear has an <a href="https://5e.tools/bestiary.html#intellect%20devourer_xmm" target="blank">intellect devourer</a> in its skull cavity.<br></br>
      ...
      {salaAtual === "1-26b" && <div className='sala' id='1-26b'>
        <p>This room has a small stage and a statue of Halaster sitting looking at the stage.</p>

        <p>If a character does something on stage that Halaster would find funny, a laugh starts sounding from the statue and then it breaks, showing a <a href="https://5e.tools/items.html#wand%20of%20smiles_xge" target="blank">wand of smiles</a> inside. The statue has 18 hit points, 17 AC and resistance to slashing and piercing damage. If it is broken, the wand inside becomes a <a href="https://5e.tools/items.html#wand%20of%20scowls_xge" target="blank">wand of scowls</a></p>
      </div>}
      {salaAtual === "1-26c" && <div className='sala' id='1-26c'>
        <p>Just around this corner is a <a href="https://5e.tools/bestiary.html#gelatinous%20cube_xmm" target="blank">gelatinous cube.</a> The first character to walk around the corner is surprised by the cube unless that character has a passive Wisdom (Perception) score of 15 or higher.</p>
      </div>}
      {salaAtual === "1-26d" && <div className='sala' id='1-26d'>
        <p>This tunnel comes to a dead end, mounted on the north wall of which is a gate to level 10 (see "Gates"). Worked into the stone frame is the graven image of a human wizard wielding a wand. The rules of this gate are as follows:</p>
        <ul>
          <li>The gate opens for 1 minute when the mirror is touched with a magic wand that has at least 1 charge remaining.</li>
          <li>Characters must be 11th level or higher to pass through this gate (see "Jhesiyra Kestellharp"). The first creature to pass through the gate triggers an elder rune (see "Elder Runes").</li>
          <li>A creature that passes through the gate appears in area 8 on level 10, in the closest unoccupied space next to the identical gate located there.</li>
        </ul>
      </div>}
      {salaAtual === "1-27" && <div className='sala' id='1-27'>
        ...
        <p><strong>Misty Portal.</strong> A mist-filled open doorway leads back to the dungeon alcove on the Material Plane.<br></br>
          ...
          <strong>Simulacrum.</strong> Seated in a high-backed oak chair in front of the painting is a simulacrum of the Mad Mage himself (created by the <a href="https://5e.tools/spells.html#simulacrum_xphb" target="blank">simulacrum</a> spell).</p>
      ...
      {salaAtual === "1-28a" && <div className='sala' id='1-28a'>
        <p>The Xanathar Guild maintains a watch post here, called "Grick Snack" by the bugbears that command it. Two <a href="https://5e.tools/bestiary.html#bugbear_xmm" target="blank">bugbears</a> and six <a href="https://5e.tools/bestiary.html#goblin_xmm" target="blank">goblins</a> are stationed in this area.</p>
      ...
      {salaAtual === "1-28c" && <div className='sala' id='1-28c'>
        <p><strong>Goblins.</strong> Unless they are led elsewhere, six <a href="https://5e.tools/bestiary.html#goblin_xmm" target="blank">goblins</a> cower behind broken halves of a stone table tipped on its side. (They peer around the table's edges with their bows aimed at the rough-hewn tunnel leading east.)<br></br>
      ...
      {salaAtual === "1-30b" && <div className='sala' id='1-30b'>
        <p>This area consists of a zigzagging hall (area 30a) and a guard room (area 30b). A berserk <a href="https://5e.tools/bestiary.html#air%20elemental_xmm" target="blank">air elemental</a> is trapped here. Its howls can be heard throughout the area. Assume it's in area 30b when the characters first arrive.</p>
      ...
      {salaAtual === "1-31" && <div className='sala' id='1-31'>
        <p><strong>Wererat.</strong> A <a href="https://5e.tools/bestiary.html#wererat_xmm" target="blank">wererat</a> named Sylvia Featherstone scours the hall in her giant rat form.<br></br>
      ...
      {salaAtual === "1-32a" && <div className='sala' id='1-32a'>
        ...
        <p>The southeastern corner of this room has what could be described as a "zen garden" with sand and rocks. The sand has beatiful spiral patterns drwan on it. Two of the rocks are actually <a href="https://5e.tools/bestiary.html#obeleric_tob3" target="blank">obelerics</a> that attack anyone who disturbs the sand.</p>
      </div>}
      ...
      {salaAtual === "1-35" && <div className='sala' id='1-35'>
        ...
        <p><strong>Giant Rats.</strong> Ten <a href="https://5e.tools/bestiary.html#giant%20rat_xmm" target="blank">giant rats</a> scour the room for food.<br></br>

          <strong>Wererat.</strong> An obese giant rat is sleeping on the seat of a crumbling stone throne that stands on a dais opposite the door. (This creature is a shapechanged <a href="https://5e.tools/bestiary.html#wererat_xmm" target="blank">wererat</a> named Flyndol Greeth.)<br></br>
      ...
      {salaAtual === "1-36a" && <div className='sala' id='1-36a'>
        ...
        <p><strong>Gricks.</strong> Two <a href="https://5e.tools/bestiary.html#grick_xmm" target="blank">gricks</a> in the middle of this partially collapsed hall attack all who enter.</p>
      ...
      {salaAtual === "1-36c" && <div className='sala' id='1-36c'>
        <p><strong>Sleeping Grick.</strong> A <a href="https://5e.tools/bestiary.html#grick%20alpha_xmm" target="blank">grick alpha</a> is coiled up in the southernmost section of the room and appears to be asleep. The creature recently gorged itself on goblins and is not hungry. If the characters stay at least 10 feet away from it and cause it no harm, it ignores them.<br></br>
          ...
          <strong>Reverse Gravity.</strong> Directly above the grick, on the 20-foot-high ceiling, is an upside-down stone throne, seated upon which is a mummified minotaur with gems embedded in its eyes (see "Treasure" below). A greataxe lies at the foot of the throne.<br></br>

          <strong>Debris.</strong> Stone debris is strewn across the floor and ceiling.<br></br>
      ...
      {salaAtual === "1-37" && <div className='sala' id='1-37'>
        ...
        <p><strong>Map.</strong> A 30-foot-wide, floor-to-ceiling <a href="dungeon.map.jpg" target="blank">map</a> is carved into the west wall (see "Fresco" below).<br></br>

          <strong>Open Pit.</strong> In the middle of the room is a 10-foot-square open pit. A <a href="https://5e.tools/bestiary.html#revenant_xmm" target="blank">revenant</a> is trapped in the pit and can be heard moving around inside it.<br></br>

          <strong>Secret Door.</strong> A secret door is hidden in the south wall. It opens into a curved tunnel (area 38).</p>

        <h2>Map Carving</h2>

        <p>This <a href="dungeon.map.jpg" target="blank">elaborate image</a> is a cross-section map of Undermountain, with what is clearly Mount Waterdeep and the City of Splendors at the top, and twenty-three hollowed-out dungeon levels stacked below it. Each dungeon level has its own stylistic side view, but no names or details are included to suggest what a level is called or what it contains. Three features stand out:</p>
        ...
        <p>When a half-elf cleric of Waukeen named Halleth Garke accused his adventuring companions of withholding treasure from him, the other members of the Fine Fellows of Daggerford (not including Kelim in area 36b, who had already wandered off) beat Halleth to death and threw his body into the pit. Halleth "awoke" the next day as a <a href="https://5e.tools/bestiary.html#revenant_xmm" target="blank">revenant</a>, compelled to find and kill the three who murdered him. Unfortunately for him, he is unable to climb out of the pit without assistance and has been pacing down there for days.</p>
      ...
      {salaAtual === "1-38" && <div className='sala' id='1-38'>
        <p>This curved corridor is hidden behind secret doors and connects areas 37 and area 39. Humanoid footprints in the dust suggest that a lot of traffic passes through here.</p>
      </div>}
      {salaAtual === "1-39a" && <div className='sala' id='1-39a'>
        <p>These chambers house the level's main Xanathar Guild watch post, called "Big Ears" by the bugbears that command it. Instead of posting lookouts, the watch post's defenders (three <a href="https://5e.tools/bestiary.html#bugbear_xmm" target="blank">bugbears</a>, nineteen <a href="https://5e.tools/bestiary.html#goblin_xmm" target="blank">goblins</a>, and two <a href="https://5e.tools/bestiary.html#ettin_xmm" target="blank">ettins</a>) rely on a <a href="https://5e.tools/bestiary.html#shrieker_xmm" target="blank">shrieker</a> to warn them of intruders.</p>

        <p>Characters will most likely enter this hall through the secret door in the west wall. This 30-foot-high room has the following features:</p>

        <p><strong>Statue.</strong> A deformed granite statue stands on the east side of a large stone column, facing eastward.<br></br>

          <strong>Staircase.</strong> West of the statue, stairs descend 200 feet to level 2. (These stairs are not immediately visible to characters entering through the secret door.)<br></br>

          <strong>Noise.</strong> The sound of squabbling goblins emanates from a tunnel leading north.</p>

        <p>The statue is life-size and depicts a dwarf king standing atop a 3-foot-high stone pedestal. Sprouting from the king's neck is a deformed, mostly featureless second head with an elongated, toothless mouth. The inscriptions on the pedestal have been worn away. On the king's brow rests an engraved stone circlet, and his large hands grasp the handle of a stone warhammer, the head of which is planted at his feet.</p>

        <p>Halaster used stone shape spells to create the statue's second head and rub away the inscriptions on the pedestal. Even the Mad Mage is unaware, however, that the statue hides a secret. Any character who examines the statue and succeeds on a DC 15 Wisdom (Perception) check notices that the king's warhammer is a separate piece of stone that can be rotated. When the warhammer is turned so that the weapon's backside faces forward, the pedestal rises another 3 feet, revealing an open cavity that contains a magic circlet identical to the one worn by the statue—but fashioned from gold rather than stone.</p>

        <p><strong>Treasure.</strong> The gold circlet is a <a href="https://5e.tools/items.html#circlet%20of%20blasting_dmg" target="blank">circlet of blasting.</a></p>
      </div>}
      {salaAtual === "1-39b" && <div className='sala' id='1-39b'>
        <p>Three <a href="https://5e.tools/bestiary.html#bugbear_xmm" target="blank">bugbears</a> sit in the middle of the floor, eating from a sack of dead rats and stirges. One of them has an <a href="https://5e.tools/bestiary.html#intellect%20devourer_xmm" target="blank">intellect devourer</a> in its skull, which is controlling it like a puppeteer. Because of the intellect devourer's Detect Sentience trait, the bugbears can't be surprised by the adventurers. When the intellect devourer's host drops to 0 hit points, the intellect devourer teleports away to seek a new host.</p>
      </div>}
      {salaAtual === "1-39c" && <div className='sala' id='1-39c'>
        <p><strong>Goblins.</strong> Nineteen loud, mean, starving <a href="https://5e.tools/bestiary.html#goblin_xmm" target="blank">goblins</a> bicker and fight over scraps of moldy food in this long hall.<br></br>

          <strong>Dead Goblin.</strong> A twentieth goblin lies dead on the floor, the victim of an argument that ended badly.</p>
      </div>}
      {salaAtual === "1-39d" && <div className='sala' id='1-39d'>
        <p><strong>Ettins.</strong> Two <a href="https://5e.tools/bestiary.html#ettin_xmm" target="blank">ettins</a>, a female named Krung-Jung and a male named Bokk-Nokkin, live in this foul-smelling room. Branded on each of their foreheads is the symbol of Xanathar: a circle with ten equidistant spokes radiating outward from it and a dot in the center.<br></br>

          <strong>Forge.</strong> A blackened forge dominates the north wall. The magic that once heated the forge expired long ago. The ettins keep their treasure inside it (see "Treasure" below). An iron anvil stands atop a 3-foot-high circular stone dais in front of the hearth.<br></br>

          <strong>Hammer.</strong> Hanging above the anvil from thick iron chains is a 7,000-pound stone hammer, 10 feet long and 8 feet wide. Carved into one side of its stone head are the Dwarvish runes for earth and water; the other side is carved with similar runes for air and fire.<br></br>

          <strong>Trophies.</strong> A 10-foot-wide, 20-foot-long, 2-foot-high slab of stone dominates the southeast corner of the forge. The ettins' latest trophies—two dead and rotting carrion crawlers—lie atop it.</p>

        <p>The ettins lived in the Underdark until Xanathar's minions found them. The brands on the ettins' foreheads signify their servitude under the beholder.</p>

        <p><strong>Treasure.</strong> Stored at the back of the forge are two large sacks. One sack contains 1,400 cp and 350 sp. The other contains 120 iron ingots worth 5 sp each. Each ingot weighs 1 pound and is stamped with a hammer on one side and an anvil on the other.</p>
      </div>}
      {salaAtual === "1-40" && <div className='sala' id='1-40'>
        <p><strong>Statues.</strong> This T-shaped hall has three alcoves, two to the north and one to the south. In each alcove is a beautifully carved granite statue depicting an 8-foot-tall, helmed elf warrior hefting a spear.<br></br>

          <strong>Mimic.</strong> Stone rubble is piled up behind the statue in the southernmost alcove. The spear held by this statue appears to be made of gold. (Both this statue and its spear are a <a href="https://5e.tools/bestiary.html#mimic_xmm" target="blank">mimic</a>. The creature uses its fake gold spear as a lure.)</p>

        <p>The mimic is a Large specimen with 75 (10d10 + 20) hit points. It knocked over the original statue and pushed the broken pieces into the back of the alcove, assuming the shape of the statue afterward.</p>
      </div>}
      {salaAtual === "1-41" && <div className='sala' id='1-41'>
        <p><strong>Stirges.</strong> A 5-foot-wide, 30-foot-long, 45-foot-deep crack has opened in the middle of the 30-foot-high ceiling, spilling rubble onto the floor. Twenty <a href="https://5e.tools/bestiary.html#stirge_xmm" target="blank">stirges</a> roost at the top of this fissure.<br></br>

          <strong>Tools.</strong> Old pickaxes and shovels are stored in two stone wheelbarrows parked in the northwest corner.</p>

        <p>The stirges hang like bats in the ceiling fissure and descend en masse to feed on creatures that make too much noise or shine light up at them. Bugbears come here occasionally to catch and kill stirges for food.</p>
      </div>}
    </div>
  );
};